...
{
    /// <summary>
    /// Ways that you could display a given kanji
    /// </summary>
    public static readonly DisplayType[] kanjiPrompts = new DisplayType[]
    {
        DisplayType.Kanji,
    ...
    /// <summary>
    /// Ways that you could display a given katakana character
    /// </summary>
    public static readonly DisplayType[] katakanaPrompts = new DisplayType[]
    {
        DisplayType.Katana,
        DisplayType.Romaji,
    };
    ...
    /// <summary>
    /// Ways that you could display a given hiragana character
    /// </summary>
    public static readonly DisplayType[] hiraganaPrompts = new DisplayType[]
    {
        DisplayType.Hiragana,
        DisplayType.Romaji,
    };
    ...
    /// <summary>
    /// Inputs that you could ask for given a singe kanji
    /// </summary>
    ...
    /// <summary>
    /// Inputs that you could ask for given a singe katakana character
    /// </summary>
    public static readonly InputType[] katakanaInputs = new InputType[]
    {
     ...
     /// <summary>
    /// Inputs that you could ask for given a singe hiragana character
    /// </summary>
    ...
    public static DisplayType GetRandomPrompt(this DisplayType[] prompts)
    {
